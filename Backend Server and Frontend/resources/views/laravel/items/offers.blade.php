                            ...
                            @foreach ($items as $item)
                                ...
                                @if(isset($offers[$item->id]))
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{$item->price}} <i class="fa-light fa-coin" style="margin-left:2px;" data-bs-toggle="tooltip" data-bs-original-title="Tokens"></i></td>
                                        <td class="text-sm font-weight-normal">
                                            ...
                                            <span class="d-flex">
                                                @can('manage-items', auth()->user())
                                                    ...
                                                    @if($item->owner == $user_id)
                                                        ...
                                                        <a href="{{ route('item-edit', $item->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit CTI">
                                                    ...
                                                    @elseif($item->owner != $user_id)
                                                        @if(isset($purchases[$item->id]))
                                                            <a href="{{ route('item-view', $item->id) }}" class="me-3" data-bs-toggle="tooltip" data-bs-original-title="Download CTI">
                                                                <i class="fas fa-download text-secondary"></i>
                                                            </a>
                                                        @else
                                                            <a href="{{ route('item-view', $item->id) }}" class="me-3" data-bs-toggle="tooltip" data-bs-original-title="Purchase CTI">
